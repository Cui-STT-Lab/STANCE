...
**Reference**: Su, H., Wu, Y., Chen, B. and Cui, Y. (2025) STANCE: a unified statistical model to detect cell-type-specific spatially variable genes in spatial transcriptomics. *Nat. Commun.* 16, 1793. https://doi.org/10.1038/s41467-025-57117-w
